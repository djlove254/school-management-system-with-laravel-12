    ...
    <div class="cards-container">
        ...
        <div class="id-card">
            ...
            <div class="card-header">
                ...
                <span class="id-badge" style="margin-left:auto">
                    STUDENT
                </span>
            ...
            <div class="card-body">
                ...
                <div class="student-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            {{ $student->academicYear->name ?? setting('session_year', '2026') }}
                        </span>
                    </div>
            ...
            <div class="card-footer">
                ...
                <div>
                    ...
                    <div class="value">
                        {{ \Carbon\Carbon::now()->endOfYear()->format('F Y') }}
                    </div>
                </div>

                <div style="text-align:center">
                    <div class="label">Signature</div>
                    <div style="border-top:1px solid rgba(255,255,255,0.4);
                                width:60px;
                                margin-top:6px">
                    </div>
                </div>
        ...
        <div class="back-card">
            ...
            <div class="back-header">
                ...
                <p style="color:#fff;font-size:9px;font-weight:700">
                    {{ setting('school_name', 'CBC School Management System') }}
                </p>

                <p>
                    If found, please return to the school address below
                </p>
