...
<body>
    ...
    <div class="page">
        ...
        <table class="marks-table">
            ...
            <tbody>
                ...
                @foreach($marks as $i => $mark)
                    ...
                    @php
                        $pct = $mark->full_marks > 0
                            ? round(($mark->marks_obtained / $mark->full_marks) * 100, 1)
                            : 0;

                        $passed = $mark->marks_obtained >=
                            ($mark->subject->pass_marks ?? 33);
                    @endphp
                    ...
                    <tr>
                        ...
                        <td class="grade-{{ $mark->grade }}">
                            {{ $mark->grade }}
                        </td>

                        <td class="{{ $passed ? 'grade-P' : 'grade-F-fail' }}">
                            {{ $passed ? 'Pass' : 'Fail' }}
                        </td>
        ...
        <div class="result-summary">
            ...
            <div class="summary-box"
                 style="background:#fef9c3;border-color:#fde68a">

                <div class="label">
                    Overall Grade
                </div>

                <div class="value" style="color:#854d0e">
                    {{ $grade }}
                </div>
